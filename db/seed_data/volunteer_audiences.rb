...
VOLUNTEER_AUDIENCES_SEED = [
  {
    ...
    hero_image: "https://placehold.co/1200x800/4a6b5c/ffffff?text=Retired+Volunteer",
    icon: "ph-tree-palm",
...

  {
    ...
    hero_image: "https://placehold.co/1200x800/5c7b4a/ffffff?text=Gap+Year+Volunteer",
...

  {
    ...
    hero_image: "https://placehold.co/1200x800/3a5c7b/ffffff?text=Internship",
    icon: "ph-briefcase",
...

  {
    ...
    hero_image: "https://placehold.co/1200x800/7b5c3a/ffffff?text=Career+Break",
    icon: "ph-coffee",
...

  {
    ...
    hero_image: "https://placehold.co/1200x800/5a4a6b/ffffff?text=Corporate+Volunteers",
    icon: "ph-buildings",
...

  {
    ...
    hero_image: "https://placehold.co/1200x800/8a5a4a/ffffff?text=Family+Volunteer",
    ...
    content: {
      ...
      "podcast_deepdive" => {
        ...
        "image" => "https://placehold.co/600x600/8a5a4a/ffffff?text=Podcast+Cover",
      ...
      "gallery_images" => (1..16).map { |i| "https://placehold.co/1200x800/8a5a4a/ffffff?text=Family+Gallery+#{i}" },
      "video_playlist" => [
